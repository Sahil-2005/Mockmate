...
//   const navigate = useNavigate(); // Replace with custom logic if not using React Router

//   const handleGenerateQuestions = () => {
//     if (jobRole.trim()) {
//       // Replace this navigation logic if you are not using React Router
//       navigate("/interview");
//     } else {
...
//     >
//       <h2 className="text-5xl md:text-6xl font-bold text-purple-900 mb-8">Start Practicing Instantly</h2>
...
//           className="text-white bg-purple-700 hover:bg-purple-800 px-12 py-5 rounded-xl text-2xl font-bold shadow-xl hover:shadow-2xl transition-all duration-300"
//         >
//           Generate Questions
//         </button>
//       </div>
